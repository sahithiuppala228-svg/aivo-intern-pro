  ...
  return (
    <div className="min-h-screen bg-muted/30 flex items-center justify-center p-6">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-4">
              <div className="flex items-center gap-3 text-muted-foreground animate-slide-up stagger-1">
                <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center">
                  <div className="w-3 h-3 rounded-full bg-success animate-pulse" />
                </div>
                <span>Smart skill assessments</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground animate-slide-up stagger-2">
                <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center">
                  <div className="w-3 h-3 rounded-full bg-success animate-pulse" />
                </div>
                <span>24/7 AI mentor support</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground animate-slide-up stagger-3">
                <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center">
                  <div className="w-3 h-3 rounded-full bg-success animate-pulse" />
                </div>
        ...
        <Card className="shadow-hover border-border animate-scale-in hover:shadow-glow transition-shadow duration-300">
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      >
                        {showSignupPassword ? <EyeOff className="w-4 h-4 text-muted-foreground" /> : <Eye className="w-4 h-4 text-muted-foreground" />}
                      </Button>
                    </div>
                  </div>
                  <div className="space-y-2">
